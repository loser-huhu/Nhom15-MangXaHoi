...
#         # --- PHẦN QUAN TRỌNG NHẤT: IMPORT TẤT CẢ MODEL ---
#         # Phải import hết để SQLAlchemy biết đường tạo bảng
#         from models.user import User
#         from models.post import Post, Comment, Like
#         from models.friend import FriendRequest
#         from models.conversation import Conversation, Message
#         # from models.notification import Notification (Nếu có)
...
def create_app():
    ...
    # 1. CẤU HÌNH UPLOAD (FIX LỖI UPLOAD_FOLDER)
    ...
    with app.app_context():
        ...
        from blueprints.friend import friend_bp
        from blueprints.chat import chat_bp
        from blueprints.upload import upload_bp  # <--- THÊM DÒNG NÀY
        # REGISTER
        app.register_blueprint(auth_bp, url_prefix='/auth')
        app.register_blueprint(user_bp, url_prefix='/user')
        app.register_blueprint(post_bp, url_prefix='/post')
        app.register_blueprint(friend_bp, url_prefix='/friend')
        app.register_blueprint(chat_bp, url_prefix='/chat')
        app.register_blueprint(upload_bp, url_prefix='/upload') # <--- THÊM DÒNG NÀY
